          ...
          <div className="flex flex-col items-center">
            ...
            <div
              className={`font-mono font-bold transition-all duration-200 ${
                getTimerVariant() === 'work'
                  ? 'text-7xl text-red-600'
                  : getTimerVariant() === 'rest'
                    ? 'text-7xl text-green-600'
                    : getTimerVariant() === 'break'
                      ? 'text-7xl text-blue-600'
                      : getTimerVariant() === 'done'
            ...
            <p
              className={`text-xl font-bold mt-3 capitalize tracking-wider ${
                getTimerVariant() === 'work'
                  ? 'text-red-700'
                  : getTimerVariant() === 'rest'
                    ? 'text-green-700'
